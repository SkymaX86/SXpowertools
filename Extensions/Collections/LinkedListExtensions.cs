...
namespace SXpowertools.Extensions
{
    ...
    {
        /// <summary>
        /// <para>DE: Fügt mehrere Items der LinkedList aufeinmal hinzu.</para>
        /// <para>EN: Add a range of items to the instance of this linked list</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>DE: Fügt ein Item an einer bestimmten Stelle der Liste hinzu</para>
        /// <para>EN: Add an item to a specific index of the list</para>
        /// </summary>
        /// <typeparam name="T">The type of the objects of the list.</typeparam>
        /// <param name="instance">The LinkedList object itself.</param>
        ...
        /// <summary>
        /// <para>DE: Fügt ein neues Item der LinkedList hinzu</para>
        /// <para>EN: Adds an new item to a linked list</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>DE: Gibt eine Node von einem bestimmten Index zurück</para>
        /// <para>EN: Get a node from a specific index</para>
        /// </summary>
        /// <typeparam name="T">The type of the objects of the list.</typeparam>
        /// <param name="instance">The LinkedList object itself.</param>
        ...
        /// <summary>
        /// <para>DE: Gibt ein Item von einem bestimmten Index zurück (Suche mit item.next)</para>
        /// <para>EN: Gets an item from an index (search via item.Next)</para>
        /// </summary>
        /// <typeparam name="T">The type of the objects of the list.</typeparam>
        /// <param name="instance">The LinkedList object itself.</param>
        /// <param name="index">The index of the target object.</param>
        ...
        /// <summary>
        /// <para>DE: Gibt den Wert eines Index zurück (Suche mit Iteration)</para>
        /// <para>EN: Get a value from an index (search via iteration)</para>
        /// </summary>
        /// <typeparam name="T">The type of the objects of the list.</typeparam>
        /// <param name="instance">The LinkedList object itself.</param>
        /// <param name="index">The index of the target object.</param>
